            ...
            <div className='container mx-auto my-8 max-w-[1200px] px-10'>
                ...
                <div className='space-y-3'>
                    ...
                    <ol className='list-inside list-decimal'>
                        <li>
                            Предотвращение попадания инфекции или инородного тела в открытую рану.
                        </li>
                        <li>
                            Определение правил наложения швов при соединении тканей кожных покровов
                            и стенок внутренних органов (с использованием Набора «NeoSet» для
                            обработки ран).
                        </li>
                    </ol>

                    <p>
                        <span className='font-semibold'>Определение: шов </span>– это процесс
                        соединения краёв ткани после хирургического вмешательства.
                    </p>
                    <p>
                    ...
                    <p>
                        <span className='font-semibold'>Ответственность:</span> хирург, перевязочная
                        медсестра.
                    </p>
                    <p>
                    ...
                    <ol className='list-inside list-disc'>
                        ...
                        <li>
                            Ёмкость КБСУ (коробка безопасной утилизации) для медицинских отходов
                            класса «Б»;
                        </li>
                    ...
                    <h3>
                        <span className='font-semibold'>1. Подготовительные операции</span>
                    </h3>
                    <ol>
                        ...
                        <li>
                            1.8 Утилизировать использованные повязки в ёмкость КБСУ с отходами
                            класса «Б» с полным погружением в раствор;
                        </li>
                        <li>
                            1.9 Снять перчатки, утилизировать с полным погружением в ёмкость с
                            отходами класса «Б» с раствором;
                        </li>
                        <li>
                            1.10 Произвести гигиеническую обработку рук по методическим
                    ...
                    <ol>
                        ...
                        <li>
                            2.6 Налить в одноразовую ёмкость (чашка, баночка) дезинфицирующий
                            раствор для обработки ран;
                        </li>
                        <li>
                            2.7 Открыть индивидуальный набор стерильных салфеток, стерильные шарики;
                        </li>
                        <li>2.8 Произвести гигиеническую обработку рук;</li>
                        <li>
                            2.9 Надеть стерильные перчатки, соблюдая правила техники одевания
                            стерильных перчаток;
                        </li>
                        <li>
                            2.10 Осмотреть рану и кожу вокруг нее. Обратить внимание на состояние
                            краев раны (слипшиеся, зияют), наличие симптомов воспаления (боль, отек,
                            гиперемия);
                        </li>
                        <li>
                            2.11 С помощью пинцета обработать линию швов, кожу вокруг раны
                            стерильными шариками смоченными дезинфицирующим раствором от центра к
                            периферии. Обработку поля провести дважды с экспозицией 1 минута;
                        </li>
                        <li>
                            2.12 Визуально оценить возможность снятия узловых швов, захватить
                            пинцетом узел шва и слегка приподнять его. Обрезать лезвием или
                            ножницами нить под узелком, как можно ближе к коже, на границе белого
                            участка нити. Осторожно без чрезмерного усилия, подтянуть за шов
                            пинцетом и удалить нить из тканей. Лежащая на поверхности часть нити при
                            вытягивании не должна попасть под кожу, чтобы не вызвать инфицирования
                            раны;
                        </li>
                        <li>2.13 Удалённую нить утилизировать в ёмкость с отходами класса «Б»;</li>
                        <li>
                            2.14 Проверить целостность рубца, при наличии раны и её зиянии сообщить
                            врачу; возможно частичное снятие швов или вторичная хирургическая
                            обработка;
                        </li>
                        <li>
                            2.15 Использованный перевязочный материал поместить в ёмкость класса
                            «Б»;
                        </li>
                        <li>
                            2.16 Положить необходимое количество стерильных асептических салфеток и
                            закрыть рану адгезивной повязкой;
                        </li>
                        <li>
                            2.17 Поместить использованные инструменты с полным погружением в ёмкость
                            с дезинфицирующим раствором;
                        </li>
                        <li>2.18 Снять перчатки и поместить в ёмкость с отходами класса «Б»;</li>
                        <li>
                            2.19 Произвести гигиеническую обработку рук по методическим
                            рекомендациям по обработки рук медицинских работников;
                        </li>
                        <li>
                            2.20 Сообщить пациенту о состоянии раны, проинструктировать его о
                            дальнейших действиях;
                        </li>
                        <li>
                            2.21 Сделать соответствующую запись о результатах выполнения перевязки в
                            медицинскую документацию.
                        </li>
                    </ol>

                    <h3>
                        <span className='font-semibold'>3. Примечание:</span>
                    </h3>
                    <ol className='list-inside list-disc'>
                        <li>
                            В течение 15-20 минут после манипуляции необходимо наблюдать за
                            состоянием повязки (фиксации, отделяемым);
                        </li>
                        <li>При пропитывании повязки кровью сообщить врачу.</li>
                    </ol>
                    <h3>
                        <span className='font-semibold'>4. Нормативные документы:</span>
                    </h3>
                    <ul>
                        <li>
