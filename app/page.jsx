...
const partners = [
    ...
    { src: "/home/partners/partner3.jpeg", alt: "ТОКБ" },
    {
        ...
        alt: "Сибирский государственный медицинский университет",
    },
]
...
export default function Home() {
    return (
        <>
                ...
                <div className='flex justify-center'>
                    <div className='grid gap-6 sm:gap-10 lg:grid-cols-2 lg:gap-12'>
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className='absolute z-20 w-full bg-white transition-opacity duration-500 hover:opacity-0'>
            ...
            <div className='container mx-auto max-w-[1200px] px-4'>
                <div className='flex justify-center'>
                    <div className='flex max-w-[1000px] flex-col items-center justify-center space-y-5 rounded-3xl bg-white p-6 drop-shadow-lg sm:p-14 lg:shrink lg:flex-row lg:space-y-0 xl:w-[1200px]'>
                        ...
                        <div className='mx-auto flex flex-1 flex-col items-center justify-center space-y-5'>
                            <h2 className='text-justify text-xl font-semibold text-txtGreen sm:text-2xl lg:text-left'>
                                Мы опирались на{" "}
                                <span className='text-mainGreen'>лучший мировой опыт</span>{" "}
                                производства медицинских изделий и{" "}
                                <span className='text-mainGreen'>
                                    заложили основные принципы качества
                                </span>{" "}
                                и <span className='text-mainGreen'>удобства использования</span>.
                                Так появился OneStep.
                            </h2>
                            <Link
                                href='/about'
            ...
            {/* <div className='container mx-auto my-3 px-4 sm:my-5'>
                ...
                <div className='flex flex-wrap justify-center lg:gap-0'>
                    {partners.map((partner, index) => (
                        <div
                            key={index}
                            className='flex w-72 items-center justify-center p-3 sm:h-28'
                        >
                            <Image
                                src={partner.src}
                                alt={partner.alt}
