        ...
        <footer className="bg-stone-200 rounded-t-3xl shadow-footer">
            <div className="container mx-auto px-6 py-6 max-w-6xl">
                ...
                {/* Реквизиты изготовителя (ст. 9 ЗОЗПП) и ссылка на политику
                    ...
                    страницы сайта. */}
                <div className="mt-6 space-y-1.5 border-t border-stone-300 pt-5 text-center text-sm text-stone-500 sm:text-left">
                    <p>Общество с ограниченной ответственностью «Производственная компания „НЕОМЕД“»</p>
                    <p>ИНН 7017479120 · ОГРН 1207000011888</p>
                    <p>634015, Томская область, г. Томск, ул. Циолковского, д. 19/1, помещение 24</p>
                    <p>
