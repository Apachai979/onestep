...
INSERT INTO "new_deals" ("contactId", "counterpartyId", "createdAt", "createdById", "id", "managerId", "note", "status", "title", "totalAmount", "updatedAt") SELECT "contactId", "counterpartyId", "createdAt", "createdById", "id", "managerId", "note", "status", "title", "totalAmount", "updatedAt" FROM "deals";
DROP TABLE "deals";
