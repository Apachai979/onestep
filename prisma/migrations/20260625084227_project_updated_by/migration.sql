...
INSERT INTO "new_projects" ("auctionDate", "createdAt", "distributorId", "duplicateComment", "endCustomerId", "externalAuctionId", "id", "internalName", "managerId", "status", "totalAmount", "updatedAt") SELECT "auctionDate", "createdAt", "distributorId", "duplicateComment", "endCustomerId", "externalAuctionId", "id", "internalName", "managerId", "status", "totalAmount", "updatedAt" FROM "projects";
DROP TABLE "projects";
