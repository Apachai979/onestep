...
INSERT INTO "new_deals" ("contactId", "counterpartyId", "createdAt", "createdById", "id", "managerId", "note", "sourceProjectId", "status", "title", "totalAmount", "updatedAt", "updatedById") SELECT "contactId", "counterpartyId", "createdAt", "createdById", "id", "managerId", "note", "sourceProjectId",
    CASE "status"
        WHEN 'NEW' THEN 'NEGOTIATION'
        WHEN 'IN_PROGRESS' THEN 'NEGOTIATION'
        WHEN 'NEGOTIATION' THEN 'NEGOTIATION'
        WHEN 'AWAITING_PAYMENT' THEN 'CONTRACT'
        WHEN 'WON' THEN 'CLOSED'
        WHEN 'LOST' THEN 'ARCHIVED'
        ELSE 'NEGOTIATION'
    END,
    "title", "totalAmount", "updatedAt", "updatedById" FROM "deals";
DROP TABLE "deals";
