...
INSERT INTO "new_deals" ("contactId", "counterpartyId", "createdAt", "createdById", "deliveryAddress", "discount", "id", "lossComment", "lossReason", "managerId", "note", "sourceProjectId", "status", "title", "totalAmount", "updatedAt", "updatedById") SELECT "contactId", "counterpartyId", "createdAt", "createdById", "deliveryAddress", "discount", "id", "lossComment", "lossReason", "managerId", "note", "sourceProjectId", "status", "title", "totalAmount", "updatedAt", "updatedById" FROM "deals";
DROP TABLE "deals";
