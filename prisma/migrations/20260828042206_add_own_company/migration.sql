...
INSERT INTO "new_counterparties" ("activityArea", "address", "bankAccount", "bankCorrAccount", "bankName", "bik", "city", "companyKind", "createdAt", "createdById", "discount", "email", "groupId", "id", "inn", "isGroupPrimary", "kpp", "managerId", "name", "note", "ogrn", "okpo", "okved", "phone", "priority", "region", "source", "totalRevenue", "type", "updatedAt", "updatedById", "website") SELECT "activityArea", "address", "bankAccount", "bankCorrAccount", "bankName", "bik", "city", "companyKind", "createdAt", "createdById", "discount", "email", "groupId", "id", "inn", "isGroupPrimary", "kpp", "managerId", "name", "note", "ogrn", "okpo", "okved", "phone", "priority", "region", "source", "totalRevenue", "type", "updatedAt", "updatedById", "website" FROM "counterparties";
...
CREATE INDEX "counterparties_isOwnCompany_idx" ON "counterparties"("isOwnCompany");
